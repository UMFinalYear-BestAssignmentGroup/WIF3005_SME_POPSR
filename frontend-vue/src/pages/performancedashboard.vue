                ...
                <div class="md-layout">
                  ...
                  >
                    ...
                    >
                      <template slot="content">
                        <h4 class="title">
                          Time Taken for PSR Pending 1 (Min)
                        </h4>
                        <p class="category">First Approval</p>
                      </template>
                  ...
                  >
                    ...
                    >
                      <template slot="content">
                        <h4 class="title">
                          Time taken for PSR Pending 2 (Min)
                        </h4>
                        <p class="category">Second Approval</p>
                      </template>
...
import personalPerformance from "@/pages";
  ...
  async created() {
    try {
      ...
      if (clog.err) {
        ...
        const userInfo = await performance.get_all_user_performance(this.year);
